...
public class FragmentGMail extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        * to the given fragment. */
        getActivity().getActionBar().setTitle(
                ...
                "  "+
                getResources().getString(R.string.pref_gmail_title));

        /*Load the preferences from an XML resource*/
        addPreferencesFromResource(R.xml.preferences_gmail);
    }
}
